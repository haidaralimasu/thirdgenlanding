  ...
  return (
    <div className="relative w-full max-w-full md:max-w-2xl mx-auto p-4 md:p-8 bg-transparent">
      ...
      <div className="relative w-full h-32">
        ...
        <div className="absolute w-full h-full flex justify-between items-center text-zinc-500 font-mono text-xs">
        ...
        <div className="overflow-x-auto p-4">
          {lines.map((line, index) => (
            ...
            >
              ...
              <pre className="text-transparent bg-clip-text bg-gradient-to-r from-zinc-200 to-zinc-400">{line}</pre>
            </motion.div>
          ))}
        </div>
      </div>
